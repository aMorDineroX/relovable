...
switch (command) {
  ...
  default:
    ...
    console.log('\nExemples:');
    console.log('  npx tsx scripts/init-sample-data.ts init');
    console.log('  npx tsx scripts/init-sample-data.ts summary');
    console.log('  npx tsx scripts/init-sample-data.ts clear');
